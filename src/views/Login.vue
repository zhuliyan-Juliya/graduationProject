<template>
  <div class="login">
      ...
      <section class="login_form">
            <div>
                <el-input type="text" v-model.trim="userform.userName" clearable  placeholder="请输入用户名"></el-input>
                <el-input type="password" v-model.trim="userform.userPwd" placeholder="请输入密码" clearable ></el-input>
            </div>
